...
class ExpenseCategoryController extends Controller{
    ...
    public function insert(Request $request){
        ...
        if($insert){
            Session()->flash('success','Successfully added expense category.');
    ...
    public function update(Request $request){
        ...
        $this->validate($request,[
          ...
          //$slug='IC'.uniqid(20);
            ...
            if($update){
                Session::flash('success','Successfully updated expense category.');
    ...
    public function softdelete(){
        ...
        if($soft){
            Session::flash('success','Successfully Deleted expense category.');
    ...
    public function restore(){
        ...
        if($restore){
            Session::flash('success','Successfully restored expense category.');
    ...
    if($delete){
        Session::flash('success','Successfully permanently deleted expense category.');
        return redirect('dashboard/recycle/expense/category');
        }else{
        Session::flash('error','Opps operation failed.');
        return redirect('dashboard/recycle/expense/category');
