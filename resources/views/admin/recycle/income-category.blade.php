                        ...
                        <tbody>
                            @foreach ($all as $data)
                                <tr>
                                    ...
                                    <td>
                                        <a  href="#" id="restore" data-bs-toggle= "modal" data-bs-target="#restoreModal" data-id="{{ $data->incate_id }}"><i class="fas fa-recycle fs-5 text-success fw-bold mx-3"></i></a> 
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form method="post" action="{{ url('dashboard/income/category/delete') }}">
                ...
                <div class="modal-content modal_content">
                    ...
                    <div class="modal-body modal_body">
                        Do you want to permanently delete this income category?
                        <input type="hidden" name="modal_id" id="modal_id" />
                    </div>
                    <div class="modal-footer modal_footer">
                        <button type="submit" class="btn btn-sm btn-success">Confirm</button>
